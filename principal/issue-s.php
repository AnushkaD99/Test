...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($iss_catErr) && empty($issueErr)){
        $sql = "INSERT INTO issues (user_id, submitted_date, issue_type, issue_cat, issue) VALUES ('$Userid','$submittedDate', '$iss_type', '$iss_cat', '$issue')";
...
<div class="sidebar">
    <ul>
        ...
        <li>
            <a href="issue-s.php"  class="active"><i class="fa-brands fa-wpforms"></i><span>Report Issue</span></a>
        </li>
        <li>
    ...
    <?php require_once '../inc/navbar.php'; ?>
        ...
        <div class="left">
                ...
                <div class="forum">
                    ...
                    <div class="btn_iss">
                        <a href="issue-p.php"><button>Personal Issues</button></a>
                        <a href="issue-s.php"><button class="active">School Issues</button></a>
                    </div>
                    <form action="" method="POST">
                        <div class="forum_box">
                            <div class="forum_con">
                                <span class="forum-topic">Application for school issue report</span>
